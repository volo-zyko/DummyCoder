...
def rng_mixed(attrs, parent_element, factory, schema_path, all_schemata):
    mixed = RngMixed(attrs, schema_path)
...
class RngMixed(rng_base.RngBase):
    def __init__(self, attrs, schema_path):
        super(RngMixed, self).__init__(attrs)
